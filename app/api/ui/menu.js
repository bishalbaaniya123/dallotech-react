module.exports = [
    ...
    child: [
      {
        ...
        name: 'Add Sales Lead',
        link: '/app/sales/customer-registration',
      },
      {
        key: 'sales-quarterly-plan',
        name: 'Sales Quarterly Plan',
        link: '/app/sales/quarterly-plan',
      },
      {
      ...
      },
      {
        key: 'post-visit',
        name: 'Post Visit',
        link: '/app/sales/post-visit',
      },
      {
        key: 'followup-sales',
        name: 'Follow Up',
        link: '/app/sales/follow-up',
      }
    ]
  },
  {
  ...
  },
  {
    ...
    child: [
      {
        key: 'job-management',
        name: 'Table1 (Small - Medium Table)',
        link: '/app/jobs/table1',
      },
      {
        key: 'job-management',
        name: 'Table2 (Editable Table)',
        link: '/app/jobs/table2',
      },
      {
        key: 'job-management',
        name: 'Table 3 (Large Table Small text)',
        link: '/app/jobs/table3',
      },
      {
        key: 'job-management',
        name: 'Table 4 (Large Table Expandable)',
        link: '/app/jobs/table4',
      }
    ]
  }/* ,
  {
