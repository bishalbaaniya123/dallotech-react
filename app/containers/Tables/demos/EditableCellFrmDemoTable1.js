...
import { anchorTable, dataApi } from './sampleDataTable1';
          ...
          >
            ...
            <div>
              <FormControl className={classes.field}>
                <InputLabel htmlFor="selection">Group</InputLabel>
                <Field
                  name="group"
                  component={Select}
                  ...
                  autoWidth={trueBool}
                >
                  <MenuItem value="Accounts/Finance-Manager Level">Accounts/Finance-Manager Level</MenuItem>
                  <MenuItem value="Reception">Reception</MenuItem>
                  <MenuItem value="Documentation Department">Documentation Department</MenuItem>
