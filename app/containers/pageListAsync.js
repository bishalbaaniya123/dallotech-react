...
// custom tables
export const table1 = Loadable({
  loader: () => import('./Tables/table1'),
  loading: Loading,
});
export const table2 = Loadable({
  loader: () => import('./Tables/table2'),
  loading: Loading,
});
export const table3 = Loadable({
  loader: () => import('./Tables/table3'),
  loading: Loading,
});
export const table4 = Loadable({
  loader: () => import('./Tables/table4'),
  loading: Loading,
});

export const sales = Loadable({
  loader: () => import('./Sales/index'),
  loading: Loading,
});

export const AddSales = Loadable({
  loader: () => import('./Sales/Add'),
  loading: Loading,
});

export const FollowUpSales = Loadable({
  loader: () => import('./Sales/FollowUp/index'),
  loading: Loading,
});

export const QuarterlyPlanSales = Loadable({
  loader: () => import('./Sales/QuarterlyPlan/index'),
  loading: Loading,
});

export const CustomerRegistrationSales = Loadable({
  loader: () => import('./Sales/CustomerRegistration/index'),
  loading: Loading,
});

export const PostVisitSales = Loadable({
  loader: () => import('./Sales/PostVisit/index'),
  loading: Loading,
});

export const pricing = Loadable({
  loader: () => import('./Pricing/index'),
  loading: Loading,
});
