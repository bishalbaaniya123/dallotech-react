        ...
        <Toolbar className={classes.toolbar}>
          ...
          <div className={classes.actions}>
            <Tooltip title="Add Item">
              ...
              <Button variant="contained" onClick={() => this.addTableItem()} color="secondary" className={classes.button}>
                <AddIcon className={classNames(isWidthUp('sm', width) && classes.leftIcon, classes.iconSmall)} />
                {isWidthUp('sm', width) && 'Add New'}
              </Button>
              {/*         <Button variant="contained" onClick={() => addNewItem(anchor, branch)} color="secondary" className={classes.button}>
                <AddIcon className={classNames(isWidthUp('sm', width) && classes.leftIcon, classes.iconSmall)} />
                {isWidthUp('sm', width) && 'Add New'}
              </Button>
     */}
...
export default withRouter(withWidth()(withStyles(styles)(MainTable)));
