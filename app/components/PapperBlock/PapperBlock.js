  ...
  render() {
    ...
    return (
      <div style={this.props.style || {}}>
        <Paper className={classNames(classes.root, noMargin && classes.noMargin, colorMode && classes.colorMode)} style={this.props.style} elevation={0}>
          <div className={classes.descBlock} style={this.props.iconStyle}>
...
PapperBlock.propTypes = {
  ...
  iconStyle: PropTypes.object.optional,
