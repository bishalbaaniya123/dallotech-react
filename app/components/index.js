...
export CrudTableSales from './Tables/CrudTableSales';
...
//Sales
export TextSuggestion from './TextSuggestion/index';

// Pricing
export CommercialInvoicePricing from './DynamicInvoice/CommercialInvoicePricing';
