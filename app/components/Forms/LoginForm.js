...
import flashFreightLogo from 'dan-images/flashFreight/flashfreight-logo.png';
      ...
      <Fragment>
        <Hidden mdUp>
          <NavLink to="/" className={classNames(classes.brand, classes.outer)}>
            <img src={flashFreightLogo} alt={brand.name} />
          </NavLink>
        </Hidden>
...
*/}
          ...
          <Typography variant="caption" className={classes.subtitle} gutterBottom align="center">
            Login to your FlashFreight account
          </Typography>
          {/*
              ...
              <div>
                <FormControl className={classes.formControl}>
                  <Field
                    ...
                    onChange={(e) => {this.props.handleChangeKey(e.target.value, 'email')}}
                  />
                </FormControl>
              </div>
              <div>
                <FormControl className={classes.formControl}>
                  <Field
                    ...
                    validate={required}
                    className={classes.field}
                    onChange={(e) => {this.props.handleChangeKey(e.target.value, 'password')}}
                  />
                </FormControl>
              </div>
